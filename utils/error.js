...
const ERR = {
	...
	EVENT_EXPIRED: new RSError('Event has expired', 'event_expired', 400),
	EVENT_ALREADY_REGISTERED: new RSError('User has already registered to the event', 'event_already_registered', 400),
