	...
	(this.image = e),
		...
		(this.sizeOfBlackWhiteBlackRun = function (e, t, n, i) {
			...
			for (
				...
				var w = r ? o : d,
					u = r ? d : o;
				if ((1 == f ? this.image[w + u * qrcode.width] && f++ : this.image[w + u * qrcode.width] || f++, 3 == f))
		...
		(this.sizeOfBlackWhiteBlackRunBothWays = function (e, t, n, i) {
			...
			return (
				...
				0 > i
					? ((o = t / (t - i)), (i = 0))
					: i >= qrcode.height && ((o = (qrcode.height - 1 - t) / (i - t)), (i = qrcode.height - 1)),
...
function BitMatrix(e, t) {
	...
	var n = e >> 5;
	for (0 != (31 & e) && n++, this.rowSize = n, this.bits = Array(n * t), n = 0; n < this.bits.length; n++)
		this.bits[n] = 0;
	this.__defineGetter__('Width', function () {
		...
		(this.setRegion = function (e, t, n, i) {
			...
			for (; i > t; t++) for (var r = t * this.rowSize, o = e; n > o; o++) this.bits[r + (o >> 5)] |= 1 << (31 & o);
		});
}
...
function BitMatrixParser(e) {
	...
	(this.bitMatrix = e),
		...
		(this.readFormatInformation = function () {
			...
			for (e = this.copyBit(7, 8, e), e = this.copyBit(8, 8, e), e = this.copyBit(8, 7, e), t = 5; t >= 0; t--)
				e = this.copyBit(8, t, e);
			if (((this.parsedFormatInfo = FormatInformation.decodeFormatInformation(e)), null != this.parsedFormatInfo))
		...
		(this.readVersion = function () {
			...
			for (var t = 0, n = e - 11, i = 5; i >= 0; i--) for (var r = e - 9; r >= n; r--) t = this.copyBit(r, i, t);
			if (
		...
		(this.readCodewords = function () {
			...
			for (
				var n = t.buildFunctionPattern(), i = !0, r = Array(t.TotalCodewords), o = 0, s = 0, a = 0, h = e - 1;
				h > 0;
				h -= 2
			) {
				6 == h && h--;
				for (var c = 0; e > c; c++)
					for (var l = i ? e - 1 - c : c, f = 0; 2 > f; f++)
						n.get_Renamed(h - f, l) ||
							(a++, (s <<= 1), this.bitMatrix.get_Renamed(h - f, l) && (s |= 1), 8 == a && ((r[o++] = s), (s = a = 0)));
				i ^= 1;
			}
...
function GF256Poly(e, t) {
	...
	this.__defineGetter__('Zero', function () {
		...
		(this.divide = function (e) {
			...
			for (
				var t = this.field.Zero, n = this, i = e.getCoefficient(e.Degree), i = this.field.inverse(i);
	...
	(this.x = e),
		...
		(this.aboutEquals = function (e, t, n) {
			return Math.abs(t - this.y) <= e && Math.abs(n - this.x) <= e
				? ((e = Math.abs(e - this.estimatedModuleSize)), 1 >= e || 1 >= e / this.estimatedModuleSize)
				: !1;
		});
}
	...
	(this.image = null),
		...
		(this.handlePossibleCenter = function (e, t, n) {
			...
			if (
				...
				!isNaN(t) && ((n = this.crossCheckHorizontal(Math.floor(n), Math.floor(t), e[2], i)), !isNaN(n)))
			) {
				e = i / 7;
		...
		(this.selectBestPatterns = function () {
			...
			if (e > 3) {
				...
				for (e = t / e, n = 0; n < this.possibleCenters.length && 3 < this.possibleCenters.length; n++)
					Math.abs(this.possibleCenters[n].EstimatedModuleSize - e) > 0.2 * e && (this.possibleCenters.remove(n), n--);
			}
...
function AlignmentPatternFinder(e, t, n, i, r, o, s) {
	(this.image = e),
		...
		(this.foundPatternCross = function (e) {
			for (var t = this.moduleSize, n = t / 2, i = 0; 3 > i; i++) if (Math.abs(t - e[i]) >= n) return !1;
			return !0;
		}),
		(this.crossCheckVertical = function (e, t, n, i) {
			var r = this.image,
			...
			for (var e = []; ; ) {
				...
				switch (t) {
					case 1:
						...
						break;
					case 2:
						for (t = this.getRomanAndFigureString(dataLength), n = Array(t.length), i = 0; i < t.length; i++)
							n[i] = t.charCodeAt(i);
						e.push(n);
						break;
					case 4:
...
(GridSampler = {
	...
	sampleGrid3: function (e, t, n) {
		for (var i = new BitMatrix(t), r = Array(t << 1), o = 0; t > o; o++) {
			for (var s = r.length, a = o + 0.5, h = 0; s > h; h += 2) (r[h] = (h >> 1) + 0.5), (r[h + 1] = a);
	...
	sampleGridx: function (e, t, n, i, r, o, s, a, h, c, l, f, d, w, u, C, E, B) {
		return (
			(n = PerspectiveTransform.quadrilateralToQuadrilateral(n, i, r, o, s, a, h, c, l, f, d, w, u, C, E, B)),
...
(DataBlock.getDataBlocks = function (e, t, n) {
	...
	for (r++, i = t - i.ECCodewordsPerBlock, t = a = 0; i > t; t++) for (s = 0; o > s; s++) n[s].codewords[t] = e[a++];
	for (s = r; o > s; s++) n[s].codewords[i] = e[a++];
	for (h = n[0].codewords.length, t = i; h > t; t++) for (s = 0; o > s; s++) n[s].codewords[r > s ? t : t + 1] = e[a++];
	return n;
}),
	(DataMask = {
	...
	(qrcode = {
		...
		decode: function (e) {
			...
			(i.onload = function () {
				...
				null != n && ((n = n.getContext('2d')), n.clearRect(0, 0, 320, 240), n.drawImage(i, 0, 0, 320, 240)),
					(e.width = i.width),
					(e.height = i.height),
					t.drawImage(i, 0, 0),
		...
		getMiddleBrightnessPerArea: function (e) {
			...
			for (r = 0; 4 > r; r++) for (o = 0; 4 > o; o++) e[o][r] = Math.floor((i[o][r][0] + i[o][r][1]) / 2);
			return e;
		},
			...
			[
				{
					...
					value: function (t, n, i, a) {
						...
						if (
							((l.style.position = 'relative'), (this._shouldScan = !0), (this._element = l), (qrcode.callback = i), s)
						) {
							var h = c.qrbox;
							...
							(o.onload = function () {
								var t = o.width,
									...
									h = (function t(n, i, a, r) {
										if (n <= a && i <= r) return { x: (a - n) / 2, y: (r - i) / 2, width: n, height: i };
										var o = n,
											c = i;
										return (
											n > a && ((i *= a / n), (n = a)),
											i > r && ((n *= r / i), (i = r)),
											e._log('Image downsampled from '.concat(o, 'X').concat(c) + ' to '.concat(n, 'X').concat(i, '.')),
											t(n, i, a, r)
										);
									})(t, c, l, d);
								if (n) {
						...
						var a = this,
							r = function (n, r) {
								...
								var o = (function () {
									...
									switch (
										((t.style.position = 'absolute'), (t.style.backgroundColor = e.BORDER_SHADER_DEFAULT_COLOR), i)
									) {
										case e.SHADED_LEFT:
										case e.SHADED_RIGHT:
