	...
	var s,
					...
					(e._showBackdrop = function (t) {
						...
						if (this._isShown && this._config.backdrop) {
							...
							hr.supportsTransitionEnd() && gt(this._element).hasClass(wt)
								? gt(this._backdrop).one(hr.TRANSITION_END, r).emulateTransitionEnd(150)
								: r();
						} else t && t();
					}),
				...
				return (
					...
					(n.show = function () {
						...
						if (this.isWithContent() && this._isEnabled) {
							...
							hr.supportsTransitionEnd() && kt(this.tip).hasClass(Wt)
								? kt(this.tip).one(hr.TRANSITION_END, h).emulateTransitionEnd(t._TRANSITION_DURATION)
								: h();
						}
					}),
					(n.hide = function (t) {
					...
					(n._enter = function (t, e) {
						...
						(e = e || kt(t.currentTarget).data(n)) ||
							((e = new this.constructor(t.currentTarget, this._getDelegateConfig())), kt(t.currentTarget).data(n, e)),
					...
					(n._getConfig = function (t) {
						return (
							'number' == typeof (t = r({}, this.constructor.Default, kt(this.element).data(), t)).delay &&
					...
					(t._jQueryInterface = function (e) {
						return this.each(function () {
							...
							if (
								...
								(n || ((n = new t(this, i)), kt(this).data(jt, n)), 'string' == typeof e)
							) {
					...
					(e._jQueryInterface = function (t) {
						return this.each(function () {
							...
							if (
								...
								(n || ((n = new e(this, i)), Jt(this).data(ee, n)), 'string' == typeof t)
							) {
				...
				return (
					...
					(e.findMdbFormGroup = function (t) {
						...
						return (
							0 === e.length &&
								t &&
								Ke.error('Failed to find ' + qe.BMD_FORM_GROUP + ' for ' + dr.describe(this.$element)),
							e
						);
					}),
					t
			...
			(function (t) {
				...
				return (
						...
						this.$element
							...
							.on('keyup change', function () {
								t.isEmpty() ? t.removeIsFilled() : t.addIsFilled(),
									t.config.validate &&
										(void 0 === t.$element[0].checkValidity || t.$element[0].checkValidity()
											? t.removeHasDanger()
											: t.addHasDanger());
							});
					}),
					...
					(n.resolveMdbLabel = function () {
						...
						return (
							(void 0 !== t && 0 !== t.length) ||
								void 0 === (t = this.findMdbLabel(this.config.label.required)) ||
								0 === t.length ||
					...
					(n.findMdbLabel = function (t) {
						...
						return (
							0 === e.length &&
								t &&
								Xe.error(
									'Failed to find ' + nn.BMD_LABEL_WILDCARD + ' within form-group for ' + dr.describe(this.$element)
								),
							e
						);
					}),
					(n.findFormGroup = function (t) {
						...
						return (
							0 === e.length && t && Xe.error('Failed to find ' + nn.FORM_GROUP + ' for ' + dr.describe(this.$element)),
							e
						);
					}),
					...
					(n._rejectWithoutRequiredClasses = function () {
						...
						for (t = e ? t : t[Symbol.iterator](); ; ) {
							...
							o ||
								Xe.error(this.constructor.name + ' element: ' + dr.describe(this.$element) + ' requires class: ' + r);
						}
					}),
					e
				);
				...
				return (
					...
					(n.rejectWithoutRequiredStructure = function () {
						dr.assert(
							...
							this.constructor.name + "'s " + dr.describe(this.$element) + ' parent element should be <label>.'
						),
							dr.assert(
								this.$element,
		...
		gr =
			...
			(mn = (function (t) {
				function e(e, n, i) {
					return (
						void 0 === i && (i = { inputType: hn, outerClass: hn }), t.call(this, e, cn.extend(!0, pn, n), i) || this
					);
				}
				return (
					o(e, t),
					...
					(e.rejectMatch = function (t, e) {
						dr.assert(
							this.$element,
							this.matches(e),
							t + ' component element ' + dr.describe(e) + " is invalid for type='checkbox'."
						);
					}),
					(e._jQueryInterface = function (t) {
						return this.each(function () {
		...
		_r =
			...
			(Cn = (function (t) {
				function e(e, n, i) {
					return (
						void 0 === i && (i = { inputType: 'checkbox', outerClass: 'checkbox-inline' }),
				...
				return (
					...
					(e.rejectMatch = function (t, e) {
						dr.assert(
							this.$element,
							this.matches(e),
							t + ' component element ' + dr.describe(e) + " is invalid for type='file'."
						);
					}),
					(n.outerElement = function () {
			...
			(Vn = (function (t) {
				function e(e, n, i) {
					return (
						void 0 === i && (i = { inputType: Un, outerClass: Un }), t.call(this, e, Hn.extend(!0, Kn, n), i) || this
					);
				}
				return (
					o(e, t),
					...
					(e.rejectMatch = function (t, e) {
						dr.assert(
							this.$element,
							this.matches(e),
							t + ' component element ' + dr.describe(e) + " is invalid for type='radio'."
						);
					}),
					(e._jQueryInterface = function (t) {
						return this.each(function () {
		...
		vr =
			...
			(ti = (function (t) {
				function e(e, n, i) {
					return (
						void 0 === i && (i = { inputType: 'radio', outerClass: 'radio-inline' }),
		...
		yr =
				...
				return (
					...
					(e.rejectMatch = function (t, e) {
						dr.assert(
							this.$element,
							this.matches(e),
							t + ' component element ' + dr.describe(e) + ' is invalid for <select>.'
						);
					}),
					(e._jQueryInterface = function (t) {
						return this.each(function () {
			...
			(gi = (function (t) {
				function e(e, n, i) {
					return (
						void 0 === i && (i = { inputType: 'checkbox', outerClass: 'switch' }),
				...
				return (
					...
					(e.rejectMatch = function (t, e) {
						dr.assert(
							this.$element,
							this.matches(e),
							t + ' component element ' + dr.describe(e) + " is invalid for type='text'."
						);
					}),
					(e._jQueryInterface = function (t) {
						return this.each(function () {
				...
				return (
					...
					(e.rejectMatch = function (t, e) {
						dr.assert(
							this.$element,
							this.matches(e),
							t + ' component element ' + dr.describe(e) + ' is invalid for <textarea>.'
						);
					}),
					(e._jQueryInterface = function (t) {
						return this.each(function () {
					...
					T = (function () {
						...
						return (
							...
							(s._getConfig = function (n) {
								...
								return (
									void 0 !== i.placement && (i.placement = b[i.placement.toUpperCase()]),
							...
							(o._jQueryInterface = function (e) {
								return this.each(function () {
									var i = t(this).data(n);
									if (
										(i || ((i = new o(this, 'object' == typeof e ? e : null)), t(this).data(n, i)),
										'string' == typeof e)
									) {
			...
			(function (t) {
				...
				return (
					...
					(n.resolveCanvas = function () {
						...
						return (
							(void 0 !== t && 0 !== t.length) ||
								(this.config.canvas.create && this.$container.wrap(this.config.canvas.template),
					...
					(n.resolveBackdrop = function () {
						...
						return (
							(void 0 !== t && 0 !== t.length) ||
								(this.config.backdrop.create && this.$container.append(this.config.backdrop.template),
	...
	(Pi = jQuery),
		...
		(Ki = (function (t) {
			function e(e, n) {
				var i;
				return (
					((i = t.call(this, e, Pi.extend(!0, {}, Bi, n)) || this).$toggles = Pi(
			...
			return (
					...
					if (!this._isTouch() || 'mousedown' !== t.type) {
						...
						(n || i) &&
							...
							this.$element.on(this.config.trigger.end, function () {
								e.$decorator &&
									(e.$decorator.data('mousedown', 'off'), 'off' === e.$decorator.data('animating') && e.rippleOut());
							}));
					}
				}),
				...
				(e._getRelX = function (t) {
					...
					return this._isTouch()
						? 1 === (t = t.originalEvent).touches.length && t.touches[0].pageX - e.left
						: t.pageX - e.left;
				}),
				(e._getRelY = function (t) {
					var e = this.$container.offset();
					return this._isTouch()
						? 1 === (t = t.originalEvent).touches.length && t.touches[0].pageY - e.top
						: t.pageY - e.top;
				}),
				...
				(e._getNewSize = function () {
					return (
						(Math.max(this.$element.outerWidth(), this.$element.outerHeight()) / this.$decorator.outerWidth()) * 2.5
					);
				}),
				(t._jQueryInterface = function (e) {
					return this.each(function () {
