		...
		for (var b = 0, c = this.data.length; b < c; b++) {
			...
			e > 65536
				? ((d[0] = 240 | ((1835008 & e) >>> 18)),
				  ...
				  (d[3] = 128 | (63 & e)))
				: e > 2048
				? ((d[0] = 224 | ((61440 & e) >>> 12)), (d[1] = 128 | ((4032 & e) >>> 6)), (d[2] = 128 | (63 & e)))
				: e > 128
		...
		return (
			0 != b.version &&
				(d <= b.version
					...
					: (console.warn('QR Code version ' + b.version + ' too small, run version use ' + d), (b.runVersion = d))),
			d
		);
	}
	function h(a) {
							...
							b + e <= -1 ||
								...
								(2 <= d && d <= 4 && 2 <= e && e <= 4)
									? ((this.modules[a + d][b + e][0] = !0),
									  ...
									  (this.modules[a + d][b + e][1] = -0 == d || -0 == e || 6 == d || 6 == e ? 'O' : 'I'))
								...
								for (var h = -2; h <= 2; h++)
									-2 == g || 2 == g || -2 == h || 2 == h || (0 == g && 0 == h)
										? ((this.modules[e + g][f + h][0] = !0),
										  ...
										  (this.modules[e + g][f + h][1] = -2 == g || -2 == h || 2 == g || 2 == h ? 'O' : 'I'))
										...
										if (n) {
											...
											if (6 == d) {
												...
												(e.fillStyle = m ? r : f.colorLight),
													...
													e.fillRect(k + (h * (1 - q)) / 2, f.titleHeight + l + (i * (1 - q)) / 2, h * q, i * q);
											} else if (6 == j) {
												q = 1;
												...
												f.backgroundImage
													? (f.autoColor
															? ((e.strokeStyle = m ? 'rgba(0, 0, 0, .6)' : 'rgba(255, 255, 255, .7)'),
